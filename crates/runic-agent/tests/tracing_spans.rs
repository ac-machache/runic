...
async fn the_span_tree_carries_the_agreed_fields() {
    ...
    for expected in [
        ...
        "turn{n=1}",
        "turn{n=2}",
        "provider_call{gen_ai.request.model=test-model",
        "gen_ai.usage.input_tokens=100 gen_ai.usage.output_tokens=20 gen_ai.response.finish_reasons=\"tool_use\"",
        "gen_ai.response.model=\"test-model\"",
        "gen_ai.system",
        "gen_ai.operation.name=\"chat\"",
        "otel.kind=\"client\"",
        "dispatch{batch=1",
        "tool{gen_ai.tool.name=echo gen_ai.tool.call.id=c1 parallel=false",
        "outcome=\"ok\"",
        "is_error=false",
