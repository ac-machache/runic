...
macro_rules! session_store_contract_suite {
    ($factory:expr) => {
        $crate::contract_suite!(
            ...
            run_rows_lifecycle,
            pause_resume_cycle,
            cancelling_a_waiting_run_prevents_resume,
            deliver_and_resume_appends_and_reidles_a_waiting_run,
            latest_run_picks_the_newest,
            runs_are_tenant_scoped,
            try_start_run_waits_for_the_running_sibling_to_finish,
            runs_on_a_thread_start_in_the_order_they_were_created,
            ordering_is_scoped_to_one_thread,
            cancel_and_steering_signals_flow_through_take_signals,
            cancelling_an_idle_run_drops_it,
